...
entry = Label(root,text="",width=15,height=2,bg="#a4a4a4",font="arial 20")
...
but_clear = Button(root,text="C",font=("arial",10,"bold"),bd=1,padx=30,pady=15,bg="#184068",fg="white",command=clear)
...
but_equal = Button(root,text="=",width=10,pady=45,fg="white",bg="#4d1b1b",bd=1,command=calculate)
